...
<p align="center">
  <picture>
    <source media="(max-width: 760px) and (prefers-color-scheme: dark)" srcset="./assets/hero/agent-console-0cc66ad7-mobile-dark.svg">
    <source media="(max-width: 760px)" srcset="./assets/hero/agent-console-0cc66ad7-mobile-light.svg">
    <source media="(prefers-color-scheme: dark)" srcset="./assets/hero/agent-console-0cc66ad7-dark.svg">
    <source media="(prefers-color-scheme: light)" srcset="./assets/hero/agent-console-0cc66ad7-light.svg">
    <img src="./assets/hero/agent-console-0cc66ad7-dark.svg" alt="Irawan Agung Nugroho - Senior Backend Engineer & Golang Specialist" width="100%">
  </picture>
</p>
